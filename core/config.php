...
define('DB_NAME', 'calendar'); // Wat is de database naam
...
define('DEFAULT_CONTROLLER', 'calender'); // Dit is de standaard controller waarmee de webapplictie wordt opgestart
